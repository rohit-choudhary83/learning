...
st.subheader('About')
st.write('Phishing attacks have emerged as a significant cybersecurity threat, exploiting human trust to steal sensitive information through deceptive websites. These attacks compromise personal data, financial credentials, and corporate security.')
